...
function getCalendarStyles() {
	...
	result += "<STYLE>\n";
	result += "."+p+"cpYearNavigation,."+p+"cpMonthNavigation { background-color:#bcc62e; text-align:center; vertical-align:center; text-decoration:none; color:#000000; font-weight:bold; }\n";
	...
	result += "TD."+p+"cpCurrentDate { color:white; background-color: #bcc62e; border-width:1px; border:solid thin #490a04; }\n";
