...
$query = "SELECT * FROM offtech.ot_survey WHERE os_date between '$startDate' and '$endDate' ORDER BY os_date;";
$result = mysql_query($query);
$result_q1 = mysql_query("SELECT avg(os_question_1) FROM offtech.ot_survey WHERE os_date between '$startDate' and '$endDate' ORDER BY os_date;");
while ($q1_avger = mysql_fetch_array ($result_q1)) {$q1_avg = $q1_avger[0];}
$result_q2 = mysql_query("SELECT avg(os_question_2) FROM offtech.ot_survey WHERE os_date between '$startDate' and '$endDate' ORDER BY os_date;");
while ($q2_avger = mysql_fetch_array ($result_q2)) {$q2_avg = $q2_avger[0];}
$result_q3 = mysql_query("SELECT avg(os_question_3) FROM offtech.ot_survey WHERE os_date between '$startDate' and '$endDate' ORDER BY os_date;");
while ($q3_avger = mysql_fetch_array ($result_q3)) {$q3_avg = $q3_avger[0];}
$result_q4 = mysql_query("SELECT avg(os_question_4) FROM offtech.ot_survey WHERE os_date between '$startDate' and '$endDate' ORDER BY os_date;");
while ($q4_avger = mysql_fetch_array ($result_q4)) {$q4_avg = $q4_avger[0];}
$result_q5 = mysql_query("SELECT avg(os_question_5) FROM offtech.ot_survey WHERE os_date between '$startDate' and '$endDate' ORDER BY os_date;");
while ($q5_avger = mysql_fetch_array ($result_q5)) {$q5_avg = $q5_avger[0];}
$result_q6 = mysql_query("SELECT avg(os_question_6) FROM offtech.ot_survey WHERE os_date between '$startDate' and '$endDate' ORDER BY os_date;");
...
echo "<table border=\"1\">";
echo "<tr>
<td bgcolor=#cccccc align=left><strong>ID</strong></td><td bgcolor=#cccccc align=left><strong>Date</strong></td>
...
<td bgcolor=#cccccc align=left><strong>Question 7</strong></td><td bgcolor=#cccccc align=left><strong>Ticket</strong></td></tr>";
$j=true;
